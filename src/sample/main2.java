...
public class main2 implements Initializable {
    ...
    @FXML private DatePicker main2Date;
    ...
    private void btnUpdateAction() throws SQLException {
        ...
        try {
            if (!textId.getText().isEmpty()) {
                ...
                main2Dao.insertToHistory(dsp2.getBarcode(), dsp2.getName(), dsp2.getType(), dsp2.getQuantity(), dsp2.getP_name(), dsp2.getP_barcode(), dsp2.getColor(), dsp2.getP_quantity(), dsp2.getDate(), dsp2.getUser_id());
            } else {
