...
public class TableDsp {
    ...
    public TableDsp(SimpleStringProperty id, SimpleStringProperty barcode, SimpleStringProperty name, SimpleStringProperty type, SimpleStringProperty quantity) {
        this.id = id;
