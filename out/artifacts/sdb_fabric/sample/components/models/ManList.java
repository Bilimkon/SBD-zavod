...
public class ManList {
    ...
    public ManList(SimpleStringProperty id, SimpleStringProperty name, SimpleStringProperty barcode, SimpleStringProperty type, SimpleStringProperty description) {
        this.id = id;
        this.name = name;
